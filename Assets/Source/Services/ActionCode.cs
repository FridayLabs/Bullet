...
public class ActionCode {
    ...
    public static ActionCode ActivateEquipmentSlot1 = new ActionCode () { Name = "Activate 1st equipment slot", KeyCode = KeyCode.Alpha0, Data = 1 };
    public static ActionCode ActivateEquipmentSlot2 = new ActionCode () { Name = "Activate 2nd equipment slot", KeyCode = KeyCode.Alpha1, Data = 2 };
    public static ActionCode ActivateEquipmentSlot3 = new ActionCode () { Name = "Activate 3rd equipment slot", KeyCode = KeyCode.Alpha2, Data = 3 };
    public static ActionCode ActivateEquipmentSlot4 = new ActionCode () { Name = "Activate 4th equipment slot", KeyCode = KeyCode.Alpha3, Data = 4 };
    public static ActionCode ActivateEquipmentSlot5 = new ActionCode () { Name = "Activate 5th equipment slot", KeyCode = KeyCode.Alpha4, Data = 5 };
    public static ActionCode ActivateEquipmentSlot6 = new ActionCode () { Name = "Activate 6th equipment slot", KeyCode = KeyCode.Alpha5, Data = 6 };
